...
/**
 * Returns the SVG markup associated with a priority class.
 *
 * @param {string} priorityClass - The CSS priority class.
 * @returns {string} The SVG markup for the selected priority.
 */
...
/**
 * Creates the complete HTML markup for a task card.
 *
 ...
 *
 * @param {Object} avatar - The assigned-person data to render.
 * @returns {string} The generated value or HTML markup.
 */
...
/**
 * Creates the checkbox markup for a task subtask.
 *
...
/**
 * Creates the complete HTML markup for a task card overlay.
 *
 * @param {Object} card - The task card data to render.
 * @returns {string} The generated value or HTML markup.
 */
