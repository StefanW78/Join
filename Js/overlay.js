...
//     const data = prepareOverlayData(card);

//     formContainer.innerHTML = getCardOverlayTemplate(data);
...
function prepareOverlayData(card) {
    return {
        ...card,
        priorityLabel: card.priorityClass.replace("prio-", ""),
        avatarsHTML: createAssignedPersons(card.avatars),
...
function getCardOverlayTemplate(card) {
    return `
        <div id="openTaskOverlay" class="task-card">
            ...
            <div class="task-card-header">
                <span class="task-tag ${card.overlayTagClass}">
                    ${card.tag}
                </span>
            ...
            <div class="task-meta">
                ...
                <div class="task-meta-item">
                    ...
                    <span class="task-meta-value">
                        ${card.priorityText}
                        <span class="priority-indicator ${card.priorityLabel}"></span>
                    </span>
                </div>
